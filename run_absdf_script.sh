#!/bin/sh
#SBATCH --job-name=absdf_script
#SBATCH --time=72:00:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --partition=defq
#SBATCH --gres=gpu:1
#SBATCH --err="/home/gas690/Download/code_gnn/sastvd/scripts/hpc/logs/absdf.log"
#SBATCH --output="/home/gas690/Download/code_gnn/sastvd/scripts/hpc/logs/absdf.log"
...
python -u /home/gas690/Download/code_gnn/sastvd/scripts/abstract_dataflow_full.py --workers 16 --no-cache --stage 1 $@
python -u /home/gas690/Download/code_gnn/sastvd/scripts/abstract_dataflow_full.py --workers 16 --no-cache --stage 2 $@
