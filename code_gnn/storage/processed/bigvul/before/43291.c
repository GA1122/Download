void CLASS identify()
{
  ...
  static const struct {
    ...
    {  1581060, "NIKON",    "E900"            ,1 },   
    {  2465792, "NIKON",    "E950"            ,1 },   
    {  2940928, "NIKON",    "E2100"           ,1 },   
    {  4771840, "NIKON",    "E990"            ,1 },   
    {  4775936, "NIKON",    "E3700"           ,1 },   
    {  5869568, "NIKON",    "E4300"           ,1 },   
    {  5865472, "NIKON",    "E4500"           ,1 },
    {  7438336, "NIKON",    "E5000"           ,1 },   
  ...
  if (height == 2624 && width == 3936)	 
    { height  = 2616;   width  = 3896; }
  if (height == 3136 && width == 4864)   
