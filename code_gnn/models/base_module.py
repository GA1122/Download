...
class BaseModule(pl.LightningModule):
    def __init__(
        ...
        metrics = torchmetrics.MetricCollection(
            [
                torchmetrics.Accuracy(task = "binary"), #Lisasin task definitioni
        ...
        #self.test_pr_curve_bin = torchmetrics.BinnedPrecisionRecallCurve(1) #Eemaldasin import-i vea tottu
